...
if((i < len)){
var k = (ks[i]);
var G__26589 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__26590 = (i + (1));
m = G__26589;
i = G__26590;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26528 = c;
var G__26528__$1 = (((G__26528 == null))?null:G__26528.prototype);
if((G__26528__$1 == null)){
return null;
} else {
return G__26528__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26530 = c;
var G__26530__$1 = (((G__26530 == null))?null:G__26530.prototype);
if((G__26530__$1 == null)){
return null;
} else {
return G__26530__$1.render;
}
})() == null)))));
});
...
var G__26535 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__26535) : reagent.impl.component.as_element.call(null,G__26535));
};
...
while (G__26616__i < G__26616__a.length) {G__26616__a[G__26616__i] = arguments[G__26616__i + 0]; ++G__26616__i;}
  args = new cljs.core.IndexedSeq(G__26616__a,0,null);
} 
return G__26615__delegate.call(this,args);};
G__26615.cljs$lang$maxFixedArity = 0;
G__26615.cljs$lang$applyTo = (function (arglist__26618){
...
var G__26536 = c;
var G__26536__$1 = (((G__26536 == null))?null:G__26536.constructor);
...
var _STAR_current_component_STAR__orig_val__26540 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26541 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26541);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26540);
}});
...
var c = this;
var G__26554_26630 = goog.object.get(c,"cljsRatom");
if((G__26554_26630 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26554_26630);
}
...
var renders_26632 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_26633 = cljs.core.first(cljs.core.vals(renders_26632));
...
if((cljs.core.count(renders_26632) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26632))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26633)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26633], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26555 = o;
goog.object.set(G__26555,cljs.core.name(k),v);
