...
var G__26617 = o;
goog.object.set(G__26617,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26654__delegate = function (args){
...
return G__26654__delegate.call(this,args);};
G__26654.cljs$lang$maxFixedArity = 0;
G__26654.cljs$lang$applyTo = (function (arglist__26658){
var args = cljs.core.seq(arglist__26658);
return G__26654__delegate(args);
});
...
var G__26625 = o;
goog.object.set(G__26625,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26629__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__26629__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26631 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26631,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26631;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26634){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26635__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__26637_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26637_SHARP_);
}));
} else {
return null;
}
...
var vec__26639 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26639,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26639,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26639,(2),null);
...
var temp__5739__auto___26672 = reagent.impl.template.key_from_vec(v);
...
var temp__5739__auto___26674 = reagent.impl.template.key_from_vec(argv);
...
var G__26643 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26643) : reagent.impl.template.as_element.call(null,G__26643));
} else {
var temp__5739__auto___26686 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___26686 == null)){
} else {
var key_26688 = temp__5739__auto___26686;
...
var G__26645 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__26645)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__26645)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26646){
var G__26647 = cljs.core.first(seq26646);
var seq26646__$1 = cljs.core.next(seq26646);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26647,seq26646__$1);
}));
...
break;
default:
var G__26703 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26703;
continue;
...
var ctx = ({});
var vec__26650 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26650,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26650,(1),null);
...
var G__26653 = (cljs.core.count(argv) - first_child);
switch (G__26653) {
case (0):
